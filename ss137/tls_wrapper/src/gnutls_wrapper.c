...
/**************************************************************************//**
 *
 * TLS wrapper for GnuTLS as needed by Kmc-Subset137 project.
 *
 * This file wraps the SS137-TLS-needs of Kmc-Subset137 project in an 
 * uniform API. This implementation makes use of GnuTLS as its low-level 
 * library. The wrapper has been tested on:
 * - gnutls 3.4.9
 * - nettle 3.1
 *
